    ...
    public class Player
    {
        ...
        public int TeamNumber
        {
            ...
            set
            {
                ...
                // update a room, if we changed our team locally
                if (this.IsLocal)
                {
                    this.SetPlayerTeamProperty();
                }
            }
        }
        ...
        private bool SetPlayerTeamProperty()
        {
            if (this.RoomReference != null && !this.RoomReference.IsOffline)
            {
                Hashtable properties = new Hashtable();
                properties[ActorProperties.PlayerTeam] = this.teamNumber;
                return this.RoomReference.LoadBalancingClient.OpSetPropertiesOfActor(this.ActorNumber, properties);
            }
