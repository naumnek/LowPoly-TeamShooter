...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingPeer : PhotonPeer
    {
        ...
        private void RoomOptionsToOpParameters(Dictionary<byte, object> op, RoomOptions roomOptions, bool usePropertiesKey = false)
        {
            ...
            if (roomOptions.CountTeams > 0)
            {
                gameProperties[GamePropertyKey.CountTeams] = roomOptions.CountTeams;
            }
        ...
        public virtual bool OpJoinRandomRoom(OpJoinRandomRoomParams opJoinRandomRoomParams)
        {
            ...
            {
                Debug.Log("OpJoinRandomRoom: " + opJoinRandomRoomParams.ExpectedMaxPlayers);
                expectedRoomProperties[GamePropertyKey.MaxPlayers] = opJoinRandomRoomParams.ExpectedMaxPlayers;
            }
            if (opJoinRandomRoomParams.ExpectedCountTeams > 0)
            {
                expectedRoomProperties[GamePropertyKey.CountTeams] = opJoinRandomRoomParams.ExpectedCountTeams;
            }
        ...
        public virtual bool OpJoinRandomOrCreateRoom(OpJoinRandomRoomParams opJoinRandomRoomParams, EnterRoomParams createRoomParams)
        {
            ...
            if (opJoinRandomRoomParams.ExpectedMaxPlayers > 0)
            {
                Debug.Log("OpJoinRandomOrCreateRoom: " + opJoinRandomRoomParams.ExpectedMaxPlayers);
                expectedRoomProperties[GamePropertyKey.MaxPlayers] = opJoinRandomRoomParams.ExpectedMaxPlayers;
            }
            if (opJoinRandomRoomParams.ExpectedCountTeams > 0)
            {
    ...
    public class OpJoinRandomRoomParams
    {
        ...
        /// <summary>Filters by the CountTeams value of rooms.</summary>
        public byte ExpectedCountTeams;
    ...
    public class ActorProperties
    {
        ...
        public const byte PlayerTeam = 252; // was: 1
    }
    ...
    public class GamePropertyKey
    {
        ...
        public const byte CountTeams = 244;
    }
