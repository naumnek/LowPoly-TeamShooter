...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        {
            return JoinRandomRoom(null, 0, 0, MatchmakingMode.FillRoom, null, null);
        }
        ...
        public static bool JoinRandomRoom(Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, byte expectedMaxCountTeams)
        {
            return JoinRandomRoom(expectedCustomRoomProperties, expectedMaxPlayers, expectedMaxCountTeams, MatchmakingMode.FillRoom, null, null);
        }
        ...
        /// <returns>If the operation got queued and will be sent.</returns>
        public static bool JoinRandomRoom(Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, byte expectedMaxCountTeams, MatchmakingMode matchingType, TypedLobby typedLobby, string sqlLobbyFilter, string[] expectedUsers = null)
        {
            if (OfflineMode)
            {
            ...
            opParams.ExpectedCountTeams = expectedMaxCountTeams;
